...
class _Account_info extends State<Account_info> {
  Widget Item(String lable, String? value, TextEditingController controller, Icon icon, TextInputType keyBoardLayout) {
    return Container(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Item("Address", txtAddress.text, txtAddress,
                  Icon(Icons.home_work), TextInputType.text),

              Item("Email ID", txtEmailID.text, txtEmailID,
                  Icon(Icons.email_outlined), TextInputType.text),

              Item("Phone Number", txtPhoneNo.text, txtPhoneNo,
                  Icon(Icons.phone), TextInputType.phone),
            ],
          ),
        )),
      ),
...
//
// class Account_info_stateless extends StatelessWidget {
//   const Account_info_stateless({Key? key}) : super(key: key);
//
//   @override
//   Widget build(BuildContext context) {
//     // return
