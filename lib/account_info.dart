...
class _Account_info extends State<Account_info> {
  ...
  void getUserInfo() async{
    DataSnapshot snapshot =await dbRef.child(_userName).get();
              ...
              Container(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: NetworkImage(
                      "https://firebasestorage.googleapis.com/v0/b/mtl-chaussures.appspot.com/o/male_avatar.png?alt=media&token=3835d6e2-56c4-4829-9114-313499dcf969"),
                  ),
              ),
              Form(
                  key: _formkey,
