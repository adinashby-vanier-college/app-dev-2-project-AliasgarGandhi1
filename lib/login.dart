                  ...
                  child: Column(
                    children: [
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () async {
                                ...
                                UserData.googleUser = true;
                                // UserData.key = "ffpk5YZaCoTMv6FjmDE00Z9haBp2";
                                UserData.address =
                                    "821 Sainte Croix Ave, Saint-Laurent, Quebec H4L 3X9";
                                UserData.phoneNumber = "8968586947";
                                UserData.userName = "Rohit Saini";
                                UserData.emailId = "rohitsaini8872@gmail.com";
                                // UserData.UserMap = {'address': "", 'email' : 'rohitsaini8872@gmail.com', 'name':'Rohit Saini'}
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => Home()));
                      ...
                      GestureDetector(
                        ...
                        child: Text.rich(
                          TextSpan(text: 'Create New Account?  ', children: [
                            TextSpan(
                              text: 'Signup',
                              style: TextStyle(
                                  color: Colors.deepOrange,
